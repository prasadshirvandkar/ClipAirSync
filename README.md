...
- **Local Network Syncing**: Synchronize clipboard data between your Mac and iPhone over your local WiFi network.
- **Privacy First**: No cloud servers, no third-party data storage. Your clipboard data never leaves your local network.
- **Real-time Updates**: Instant clipboard sharing as you copy/paste on different devices.
